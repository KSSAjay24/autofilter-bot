...
API_HASH = environ('API_HASH','f580b015eeec1f8cfb524210f426dcfa')
BOT_TOKEN = environ('BOT_TOKEN','6378259064:AAFD80WjID9qlZJdiLtEqkmpNhwNQ73QBIg')
# Bot settings
WEBHOOK = bool(environ.get("WEBHOOK", )) # for web support on/off
...
WELCOM_PIC = environ.get("WELCOM_PIC", "https://graph.org/file/cfa66440c0e6f1007dcf5.jpg")
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', '-1002078537393')
